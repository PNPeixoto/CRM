...
export type ResumoDeAcessoWire = Schema<'AccessSummary'>;
export type CanalRequestWire = Schema<'CanalRequest'>;
export type CanalWire = Schema<'CanalResponse'>;
export type PareamentoWire = Schema<'PareamentoResponse'>;
export type CatalogoDePapeisWire = Schema<'CatalogoResponse'>;
export type PapelWire = Schema<'PapelResponse'>;
export type MembroWire = Schema<'MembroResponse'>;
export type EquipeWire = Schema<'EquipeResponse'>;
...
export type EventoWire = Schema<'EventoResposta'>;
...
export type PaginaConversasWire = Schema<'PaginaConversas'>;
export type PaginaEventosWire = Schema<'PaginaEventos'>;
export type PaginaMensagensWire = Schema<'PaginaMensagens'>;
